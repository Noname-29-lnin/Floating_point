...
void Vtb_UART_Rx_Data___024root___eval_triggers__ico(Vtb_UART_Rx_Data___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_UART_Rx_Data___024root___eval_triggers__ico\n"); );
    // Body
...
void Vtb_UART_Rx_Data___024root___eval_triggers__act(Vtb_UART_Rx_Data___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtb_UART_Rx_Data__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_UART_Rx_Data___024root___eval_triggers__act\n"); );
    // Body
    vlSelf->__VactTriggered.set(0U, (((IData)(vlSelf->tb_UART_Rx_Data__DOT__i_clk) 
                                      & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__tb_UART_Rx_Data__DOT__i_clk__0))) 
                                     | ((~ (IData)(vlSelf->tb_UART_Rx_Data__DOT__i_rst_n)) 
                                        & (IData)(vlSelf->__Vtrigprevexpr___TOP__tb_UART_Rx_Data__DOT__i_rst_n__0))));
    vlSelf->__VactTriggered.set(1U, (((IData)(vlSelf->UART_Rx_Test__02Ei_clk) 
                                      & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__UART_Rx_Test__02Ei_clk__0))) 
                                     | ((~ (IData)(vlSelf->UART_Rx_Test__02Ei_rst_n)) 
                                        & (IData)(vlSelf->__Vtrigprevexpr___TOP__UART_Rx_Test__02Ei_rst_n__0))));
    vlSelf->__VactTriggered.set(2U, ((IData)(vlSelf->UART_Rx_Test__02Ei_clk) 
                                     & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__UART_Rx_Test__02Ei_clk__0))));
    vlSelf->__VactTriggered.set(3U, (((IData)(vlSelf->UART_Tx_Data__02Ei_clk) 
                                      & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__UART_Tx_Data__02Ei_clk__0))) 
                                     | ((~ (IData)(vlSelf->UART_Tx_Data__02Ei_rst_n)) 
                                        & (IData)(vlSelf->__Vtrigprevexpr___TOP__UART_Tx_Data__02Ei_rst_n__0))));
    vlSelf->__VactTriggered.set(4U, vlSelf->__VdlySched.awaitingCurrentTime());
    vlSelf->__VactTriggered.set(5U, ((IData)(vlSelf->tb_UART_Rx_Data__DOT__i_clk) 
                                     & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__tb_UART_Rx_Data__DOT__i_clk__0))));
