...
VL_ATTR_COLD void Vtb_FPU_unit_COMP_4bit___ctor_var_reset(Vtb_FPU_unit_COMP_4bit* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtb_FPU_unit__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtb_FPU_unit_COMP_4bit___ctor_var_reset\n"); );
    // Body
