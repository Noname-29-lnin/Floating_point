...
#ifndef VERILATED_VTB_FPU_UNIT_CLA_4BIT_H_
#define VERILATED_VTB_FPU_UNIT_CLA_4BIT_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtb_FPU_unit_CLA_4bit final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vtb_FPU_unit_CLA_4bit(Vtb_FPU_unit__Syms* symsp, const char* v__name);
    ~Vtb_FPU_unit_CLA_4bit();
    VL_UNCOPYABLE(Vtb_FPU_unit_CLA_4bit);
