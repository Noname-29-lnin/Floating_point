...
Vtb_COMP_28bit::Vtb_COMP_28bit(const char* _vcname__)
    : Vtb_COMP_28bit(Verilated::threadContextp(), _vcname__)
{
}
...
#endif  // VL_DEBUG
void Vtb_COMP_28bit___024root___eval_static(Vtb_COMP_28bit___024root* vlSelf);
void Vtb_COMP_28bit___024root___eval_initial(Vtb_COMP_28bit___024root* vlSelf);
void Vtb_COMP_28bit___024root___eval_settle(Vtb_COMP_28bit___024root* vlSelf);
void Vtb_COMP_28bit___024root___eval(Vtb_COMP_28bit___024root* vlSelf);

void Vtb_COMP_28bit::eval_step() {
    VL_DEBUG_IF(VL_DBG_MSGF("+++++TOP Evaluate Vtb_COMP_28bit::eval_step\n"); );
#ifdef VL_DEBUG
    // Debug assertions
    Vtb_COMP_28bit___024root___eval_debug_assertions(&(vlSymsp->TOP));
#endif  // VL_DEBUG
    ...
    if (VL_UNLIKELY(!vlSymsp->__Vm_didInit)) {
        ...
        Vtb_COMP_28bit___024root___eval_static(&(vlSymsp->TOP));
        Vtb_COMP_28bit___024root___eval_initial(&(vlSymsp->TOP));
        Vtb_COMP_28bit___024root___eval_settle(&(vlSymsp->TOP));
    }
    VL_DEBUG_IF(VL_DBG_MSGF("+ Eval\n"););
    Vtb_COMP_28bit___024root___eval(&(vlSymsp->TOP));
    // Evaluate cleanup
    Verilated::endOfEval(vlSymsp->__Vm_evalMsgQp);
}

void Vtb_COMP_28bit::eval_end_step() {
    VL_DEBUG_IF(VL_DBG_MSGF("+eval_end_step Vtb_COMP_28bit::eval_end_step\n"); );
#ifdef VM_TRACE
    // Tracing
...
//============================================================
// Events and timing
bool Vtb_COMP_28bit::eventsPending() { return !vlSymsp->TOP.__VdlySched.empty(); }

uint64_t Vtb_COMP_28bit::nextTimeSlot() { return vlSymsp->TOP.__VdlySched.nextTimeSlot(); }

//============================================================
// Utilities

const char* Vtb_COMP_28bit::name() const {
    return vlSymsp->name();
}
...
void Vtb_COMP_28bit___024root___eval_final(Vtb_COMP_28bit___024root* vlSelf);

VL_ATTR_COLD void Vtb_COMP_28bit::final() {
    Vtb_COMP_28bit___024root___eval_final(&(vlSymsp->TOP));
}

//============================================================
// Implementations of abstract methods from VerilatedModel

const char* Vtb_COMP_28bit::hierName() const { return vlSymsp->name(); }
const char* Vtb_COMP_28bit::modelName() const { return "Vtb_COMP_28bit"; }
unsigned Vtb_COMP_28bit::threads() const { return 1; }
void Vtb_COMP_28bit::prepareClone() const { contextp()->prepareClone(); }
void Vtb_COMP_28bit::atClone() const {
    contextp()->threadPoolpOnClone();
}
std::unique_ptr<VerilatedTraceConfig> Vtb_COMP_28bit::traceConfig() const {
...
void Vtb_COMP_28bit___024root__trace_decl_types(VerilatedVcd* tracep);

void Vtb_COMP_28bit___024root__trace_init_top(Vtb_COMP_28bit___024root* vlSelf, VerilatedVcd* tracep);
...
VL_ATTR_COLD static void trace_init(void* voidSelf, VerilatedVcd* tracep, uint32_t code) {
    ...
    Vtb_COMP_28bit___024root__trace_decl_types(tracep);
    Vtb_COMP_28bit___024root__trace_init_top(vlSelf, tracep);
    tracep->popPrefix();
}
