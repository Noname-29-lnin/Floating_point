...
void Vtb_UART_Tx_Data___024root___eval_triggers__act(Vtb_UART_Tx_Data___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_UART_Tx_Data___024root___eval_triggers__act\n"); );
    // Body
    vlSelf->__VactTriggered.set(0U, (((IData)(vlSelf->tb_UART_Tx_Data__DOT__i_clk) 
                                      & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__tb_UART_Tx_Data__DOT__i_clk__0))) 
                                     | ((~ (IData)(vlSelf->tb_UART_Tx_Data__DOT__i_rst_n)) 
                                        & (IData)(vlSelf->__Vtrigprevexpr___TOP__tb_UART_Tx_Data__DOT__i_rst_n__0))));
    ...
    vlSelf->__VactTriggered.set(3U, ((IData)(vlSelf->tb_UART_Tx_Data__DOT__i_clk) 
                                     & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__tb_UART_Tx_Data__DOT__i_clk__0))));
