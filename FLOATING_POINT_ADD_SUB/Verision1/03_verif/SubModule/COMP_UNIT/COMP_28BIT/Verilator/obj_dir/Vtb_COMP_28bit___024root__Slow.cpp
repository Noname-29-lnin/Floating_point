...
void Vtb_COMP_28bit___024root___configure_coverage(Vtb_COMP_28bit___024root* vlSelf, bool first);

void Vtb_COMP_28bit___024root::__Vconfigure(bool first) {
    (void)first;  // Prevent unused variable warning
    Vtb_COMP_28bit___024root___configure_coverage(this, first);
}
...
// Coverage
void Vtb_COMP_28bit___024root::__vlCoverInsert(uint32_t* countp, bool enable, const char* filenamep, int lineno, int column,
