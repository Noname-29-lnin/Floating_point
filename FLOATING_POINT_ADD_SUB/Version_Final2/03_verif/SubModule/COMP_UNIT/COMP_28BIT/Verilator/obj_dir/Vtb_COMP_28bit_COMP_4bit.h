...
#ifndef VERILATED_VTB_COMP_28BIT_COMP_4BIT_H_
#define VERILATED_VTB_COMP_28BIT_COMP_4BIT_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtb_COMP_28bit_COMP_4bit final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vtb_COMP_28bit_COMP_4bit(Vtb_COMP_28bit__Syms* symsp, const char* v__name);
    ~Vtb_COMP_28bit_COMP_4bit();
    VL_UNCOPYABLE(Vtb_COMP_28bit_COMP_4bit);
